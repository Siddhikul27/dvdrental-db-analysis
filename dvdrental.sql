...
/* Question 2 :What is the Average rental rate for each genre? (from the highest to the lowest)*/
...
/* Question 3: How many rented films were returned late, early and on time?*/
...
/* Question 4: In which countries does Rent A Film have a presence in and what is the customer base in each country? What are the total sales in each country? (From most to least)*/
...
/*Question 5:Who are the top 5 customers per total sales and can we get their detail just in case Rent A Film want to reward them?*/
